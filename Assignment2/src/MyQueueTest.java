...
public class MyQueueTest {
	...
	public void setUp() throws Exception {
		...
		doubleQ.enqueue(67.9);
		doubleQ.enqueue(89.0);
		doubleQ.enqueue(8.5);
	...
	public void testDequeue() {
	 ...
	 @Test
	 public void testDequeueStudent() throws QueueUnderflowException { //Using the doubleQ for student test
		 try {
				assertEquals(67.9, doubleQ.dequeue());
				assertEquals(89.0, doubleQ.dequeue());
	...
	public void testEnqueue() {
	 ...
	 @Test 
	 public void testEnqueueStudent() { //Using the doubleQ for student test
		 try {
				assertEquals(3, doubleQ.size());
				assertEquals(true, doubleQ.enqueue(86.4));
				assertEquals(4, doubleQ.size());
				assertEquals(true, doubleQ.enqueue(43.0));
	...
	public void testToString() throws QueueOverflowException {
	 ...
	 @Test 
	 public void testToStringStudent() throws QueueOverflowException { //Using the intQ for student test
		 assertEquals("1020", intQ.toString());
		 intQ.enqueue(30);
		 assertEquals("102030", intQ.toString());
	 }
